...
<div class="content clear">
    <form action="<?php echo U('Checklogin/school_info');?>" method="post" id="form1" enctype="multipart/form-data" >
        <div class="left">
                ...
                <div class="main-content-fun-select g_padd new">
                    ...
                    <div class="bdbox">
                        <div class="form-group">
                            ...
                            <input type="file" name="image" value="" id="image" style="border: none;">
                        </div>
                        <div class="form-group">
                            <label class=""  for="image_t">上传身份证反面</label>
                            <input type="file" name="image_t" value="" id="image_t" style="border: none;">
                        </div>
                    </div>
                </div>
    ...
    function check_field(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.code==1){
                    var index=layer.confirm('订单的服务费为'+data.data.school_info, {
                        btn: ['确认','取消'] //按钮
                    }, function(index){
