...
<div class="content clear" style="width: 100%;">
	<div class="_content2 clear">
		<div class="_left2">
			<ul class="_login">
				<li class="_act li " id="one">个人登录</li>
				<li class="li " id="two">企业登录</li>
				<li class="li2">
					<a href="<?php echo U('Checklogin/register');?>">请注册</a>
					<a href="<?php echo U('Checklogin/forget_login');?>">找回密码</a>
				</li>
			</ul>
			<form action="<?php echo U('Home/Checklogin/do_login');?>" class="p_login p_login1 change_o" method="post" id="form1" style="width: 70%;font-size: 16px;">
				<label for="">手机号:</label>
			...
			<form action="<?php echo U('Home/Checklogin/do_company_login');?>" class="p_login  change_t" style="width: 70%;font-size: 16px;" method="post" id="form2">
