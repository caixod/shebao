   ...
   <!--<div class="ab_l_li">-->
    ...
    <!--</div>-->
        ...
        <div class="ab_right" style="border-radius: 10px;border: 3px solid #ddd;">
            <div class="ab_r_tt">
                <span style="display:block; float:left; margin-left:23px; font-size:18px; color:#ae2c26;"><?php echo ($service_name); ?>订单查看</span>
                <span style="float: right" class="nav_xiao"><img src="/Template/pc/default/Static/images/new/homeimg_03.jpg">当前位置：<a href="#">个人中心 ></a><a style="color:#ae2c26;">订单查看</a></span>
            </div>
            <div class="ab_r_cc">
                <!--<a href="javascript:history.back();" style="padding-left:90%;font-size: 18px;"> <i class="fa fa-angle-double-left"></i>返回</a>-->
                <div class="row">
                    <style type="text/css">
                        .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th { font-size:1.3rem;text-align: center;vertical-align:middle;}
                        .tex_div3 { width: 100%;}
                        .table .td_h1 { width: 10%;}
                        .table .td_h2 { width: 15%;}
                        .table .td_h3 { width: 20%;}
                        .table .td_h5 { text-align: left; font-size: 1.5rem; font-weight: bold; padding-left:15px;}
                        .table-responsive td {
                            padding: 15px 15px;
                            border-width: 1px;
                    ...
                    <div class="col-sm-12" style="padding: 5px;">
                        <div class="tex_div tex_div2 tex_div3">
                            <!--<p class="p_sh">订单详情</p>-->

                            <div class="tab_main2" style="width: 100%;">
                                <div class="tab1 tab_chang" style="display: block;">
                          ...
                          <?php if(is_array($mess)): $k = 0; $__LIST__ = $mess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($k % 2 );++$k;?><tr>
                                            ...
                                            <tr>
                                                ...
                                                <th class="td_h3" colspan="2"><?php echo ($info["username"]); ?></th>
                                                <th class="td_h1">性别</th>
                                                <th class="td_h3" colspan="2">
                                                    <?php switch($info["sex"]): case "1": ?>男<?php break;?>
                                            ...
                                            <tr>
                                                ...
                                                <th class="td_h3" colspan="2"><?php echo ($info["pname"]); ?>—<?php echo ($info["cname"]); ?></th>
                                                <th class="td_h1">联系电话</th>
                                                <th class="td_h3" colspan="2">
                                                    <?php echo ($info["mobile"]); ?>
                                                </th>
                                                <th class="td_h1" >下单日期</th>
                                                <th class="td_h3" colspan="2"><?php echo (date('Y-m-d',$info["add_time"])); ?></th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th class="td_h3" colspan="2">
                                                    <?php if(empty($info['certify']) == true): ?>暂未上传 <?php else: ?><a href="<?php echo ($info["certify"]); ?>">点击下载</a><?php endif; ?>
                                                </th>
                                                <th class="td_h2" >合同</th>
                                                <th class="td_h3" colspan="2">
                                                    <?php if(empty($info['ht']) == true): ?>暂未上传
                                                        <?php else: ?>
                                                        <a href="<?php echo ($info["ht"]); ?>">点击下载</a><?php endif; ?>
                                                </th>
                                        ...
                                        <?php if($pay_data["is_pay"] == 0): ?><a href="<?php echo U('Home/order/get_parameter',array('table'=>yd_bajy,'order_sn'=>$order_sn));?>" style="width: 50%;margin:10px auto;" class="btn btn-success  btn-block">去支付</a><?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
