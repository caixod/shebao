   ...
   <!--<div class="ab_l_li">-->
    ...
    <!--</div>-->
        ...
        <div class="ab_right" style="border-radius: 10px;border: 1px solid #ddd;">
            <div class="ab_r_tt">
                <span style="display:block; float:left; margin-left:23px; font-size:18px; color:#ae2c26;">增值服务提报</span>
                <span style="float: right" class="nav_xiao"><img src="/Template/pc/default/Static/images/new/homeimg_03.jpg">当前位置：<a href="#">个人中心</a>> <a style="color:#ae2c26;">增值服务提报</a></span>
            </div>
            <div class="ab_r_cc">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="denglu">
                            <div class="denglu_div" style="background-color: #ffffff;width: 90%;border: none;margin: 0px auto;">
                                <form role="form" method="post" action="" onsubmit=" return checkForm();" style="">
                                    <div class="form-group">
                                        <label for="username">联系人：</label>
                                        <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="username" placeholder="联系人" name="username" value="" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;'>
                                    </div>
                                    <div class="form-group">
                                        <label for="username">联系电话：</label>
                                        <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="mobile" placeholder="手机号码" name="mobile" value="" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;'>
                                    </div>
                                    <div class="form-group">
                                        <label for="username">增值服务标题：</label>             <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="title" placeholder="请输入标题" name="title" value="" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;'>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">增值服务内容</label>           <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <textarea class="form-control" rows="3" name="content" id="content" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;'></textarea>
                                    </div>

                                    <button type="submit" class="btn btn-success  btn-block"  style="width: 50%;margin-left: 25%;">提交</button>
                                </form>
                            </div>
                        </div>
                    </div>
