            ...
            <div class="ab_r_cc">
                ...
                <div class="row">
                    <style type="text/css">
                        ...
                        .tex_div3 { width: 100%;}
                        .table .td_h1 { width: 8%;}
                        .table .td_h2 { width: 11%;}
                        .table .td_h3 { width: 11%;}
                           ...
                           <?php if(is_array($mess)): $k = 0; $__LIST__ = $mess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($k % 2 );++$k;?><tr>
                               ...
                               <tr>
                                   ...
                                   <td class="td_h3"><?php echo ($info["own_total"]); ?></td>
                                        ...
                                        <?php if($pay_data["is_pay"] == 0): ?><a href="<?php echo U('Home/order/get_parameter',array('table'=>sb_bujiao,'order_sn'=>$order_sn));?>" style="width: 50%;margin:10px auto;" class="btn btn-success  btn-block">去支付</a><?php endif; ?>
                                    </div>
