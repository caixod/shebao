    ...
    <!--</div>-->
        ...
        <div class="ab_right" style="border-radius: 10px;border: 1px solid #ddd;">
            <div class="ab_r_tt">
                ...
                <span style="float: right" class="nav_xiao"><img src="/Template/pc/default/Static/images/new/homeimg_03.jpg">当前位置：<a href="#">个人中心</a>&gt;<a href="" style="color:#ae2c26;">朋友信息</a></span>
            </div>
            <div class="ab_r_cc">
                <div class="row">
                    <p class="text-right"><abbr title="添加朋友信息"> <a href="<?php echo U('Home/Order/add_friend_info');?>" style="text-decoration: none;"><i class="layui-icon" style="font-size: 30px; color: #1E9FFF;" > &#xe654;</i></a></abbr></p>
                        ...
                        <div class="denglu">
                            <div class="denglu_div" style="background-color: #ffffff;">
                              ...
                              <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                      ...
                                      <td>
                                          <?php if($vo["nature"] == 1): ?>农村户口
                                              <?php else: ?>
                                              城镇户口<?php endif; ?>
                                      </td>
                                      <td style="cursor: pointer;">
                                          <a href="<?php echo U('Home/Order/add_friend_info',array('user_id'=>$vo['user_id'] ));?>"> <i class="layui-icon" style="font-size: 20px; color: #1E9FFF;"> &#xe642;</i></a>
                                          &nbsp;&nbsp;&nbsp;
                                         <i class="layui-icon" style="font-size: 20px; color: #1E9FFF;"  onclick="del(this,<?php echo ($vo["user_id"]); ?>);"> &#xe640;</i>
