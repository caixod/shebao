   ...
   <!--<div class="ab_l_li">-->
    ...
    <!--</div>-->
        ...
        <div class="ab_right" style="border-radius: 10px;border: 1px solid #ddd;">
            <div class="ab_r_tt">
                <span style="display:block; float:left; margin-left:23px; font-size:18px; color:#ae2c26;">基本信息修改</span>
                <span style="float: right" class="nav_xiao"><img src="/Template/pc/default/Static/images/new/homeimg_03.jpg">当前位置：<a href="#">个人中心</a>> <a style="color:#ae2c26;">基本信息</a></span>
            </div>
            <div class="ab_r_cc">
                <div class="row">

                    <!--<hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">-->
                    <div class="col-sm-12">
                        <div class="denglu">
                            <div class="denglu_div" style="background-color: #ffffff;width: 90%;border: none;margin: 0px auto;">
                                <form role="form" method="post" action="<?php echo U('Home/Order/edit_info');?>" onsubmit=" return checkForm();" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <label for="username">姓&nbsp&nbsp&nbsp&nbsp&nbsp名：</label>
                                        <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="username" placeholder="请输入姓名" name="username" value="<?php echo ($info["username"]); ?>" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;margin-bottom: 10px;'>

                                        <label for="mobile">联系电话：</label>
                                        <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="mobile" placeholder="联系电话" name="mobile" value="<?php echo ($info["mobile"]); ?>" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;margin-bottom: 10px;'>

                                        <label for="mobile">身份证号：</label>
                                        <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="idcard" placeholder="身份证号码" name="idcard" value="<?php echo ($info["idcard"]); ?>" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;margin-bottom: 10px;'>

                                        <label for="mobile">卡&nbsp&nbsp&nbsp&nbsp号：</label>
                                        <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="bank_num" placeholder="银行卡号" name="bank_num" value="<?php echo ($info["bank_num"]); ?>" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;margin-bottom: 10px;'>

                                        <label for="mobile">开&nbsp户&nbsp行：</label>
                                        <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                        <input type="text" class="form-control" id="bank_name" placeholder="开户行" name="bank_name" value="<?php echo ($info["bank_name"]); ?>" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;margin-bottom: 10px;'>
                                    </div>
                                    <label for="mobile">性&nbsp&nbsp&nbsp&nbsp别：</label>
                                    <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                    <div class="form-group" style='width: 50%;margin-left: 50px;font-family: "Microsoft yahei", "微软雅黑", "Tahoma", "Verdana", "Arial", "sans-serif";font-size: inherit;height:38px;margin-bottom: 10px;'>
                                    ...
                                    <label class="" for="image">证件信息：</label>
                                    <hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">
                                    <div class="form-group" >
                                        ...
                                        <?php if(!empty($info['image'])): ?><a href="<?php echo ($info["image"]); ?>" target="_blank"><i class="fa fa-link"></i> 查看</a><?php endif; ?>
                                        <br />
                                        <!--<hr style="margin: 0 5px;border: 1px solid #dddddd;margin-bottom: 15px;transform: scaleY(.5);">-->
                                        <label class=""  for="image_t">上传身份证反面：</label>
                                        <input type="file" name="image_t" value="" id="image_t"  style="display: inline-block;width: 50%;" >
                                        <?php if(!empty($info['image_t'])): ?><a href="<?php echo ($info["image_t"]); ?>" target="_blank"><i class="fa fa-link"></i> 查看</a><?php endif; ?>
                                    </div>
                                    <input type="hidden" name="id" value="<?php echo ($info["user_id"]); ?>">
                                    <button type="submit" class="btn btn-success  btn-block" style="width: 50%;margin-left: 25%;">保存</button>
                                </form>
                            </div>
                        </div>
                    </div>
