                            ...
                            <div class="col-sm-12">
                                <table id="list-table" class="table table-bordered table-striped dataTable">
                                    ...
                                    <?php if(is_array($order_mess)): foreach($order_mess as $k=>$vo): ?><tr role="row" style="text-align: center;">
                                            ...
                                            <td>
                                                <?php if($vo["tq_type"] == 1): ?>租房公积金提取
                                                    <?php elseif($vo["tq_type"] == 2): ?>
                                                        买房公积金提取
                                                   <?php else: ?>
                                                        租房和买房两者公积金提取<?php endif; ?>
                                            ...
                                            <td>
                                             <?php echo ($vo["status"]); ?>
                                              ...
                                              <td  style="width: 140px;">
                                                  <a href="<?php echo U('Admin/Order/gjj_tiqu_edit',array('id'=>$vo['id']));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="处理订单"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
