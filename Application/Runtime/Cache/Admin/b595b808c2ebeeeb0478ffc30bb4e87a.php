...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index.php/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="/Public/images/TP-shop_logo.png" width="40" height="30">&nbsp;&nbsp;<b>慧智博思</b></span>
      </a>
        ...
        <ul class="sidebar-menu">
	      <?php if(is_array($menu_list)): foreach($menu_list as $k=>$vo): if(!empty($vo["sub_menu"])): ?><li class="treeview">
	            ...
	            <ul class="treeview-menu">
	            	<?php if(is_array($vo["sub_menu"])): foreach($vo["sub_menu"] as $kk=>$vv): ?><li onclick="makecss(this)" data-id="<?php echo ($vv["act"]); ?>_<?php echo ($vv["control"]); ?>" id="o_<?php echo ($kk); ?>">
						<a href='<?php echo U("$vv[control]/$vv[act]");?>' target='rightContent'><i class="fa fa-circle-o"></i><?php echo ($vv["name"]); if(($kou['o_'.$kk] != 0) AND ($vv['control'] == 'Order')): ?><span class="label label-warning"><?php echo $kou['o_'.$kk]; ?></span><?php endif; ?></a>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy; 2017-2025 慧智博思</strong>。
	</footer>
