    ...
    <div class="container-fluid">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-list"></i>公积金信息列表</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="sorting text-center"  >个人公积金比例(%)</th>
                                <th class="sorting text-center"  >单位公积金比例(%)</th>
                                <th class="sorting text-center"  >公积金最小基数</th>
                                <th class="sorting text-center"  >公积金最大基数</th>
                            ...
                            <?php if(is_array($area_list)): $k = 0; $__LIST__ = $area_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><tr>
                                    ...
                                    <td class="text-center">
                                        <?php echo ($list["city"]["gjj_bilie"]); ?>
                                    </td>
                                    <td class="text-center">
                                        <?php echo ($list["city"]["c_gjj_bilie"]); ?>
                                    </td>

                                      <td class="text-center">
                                        <?php echo ($list["city"]["gjj_minbase"]); ?>
                                    </td>
                                      <td class="text-center">
                                        <?php echo ($list["city"]["gjj_maxbase"]); ?>
                                    </td>


                                    <td class="text-center">
                                        <a href="<?php echo U('Admin/Manage/gjj_edit',array('id'=>$list['id']));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
