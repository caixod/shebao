                                ...
                                <form class="navbar-form form-inline" action="" method="get" onsubmit="return check_form();">
                                    ...
                                    <div class="form-group">
                                        <select name="status" class="form-control">
                                            ...
                                            <option value="10" <?php if ($status == 10) {echo "selected";} ?>>待处理</option>
                                            <option value="1" <?php if ($status == 1) {echo "selected";} ?>>已处理</option>
                                            <option value="2" <?php if ($status == 2) {echo "selected";} ?>>无法办理</option>
                                    ...
                                    <?php if(is_array($order_mess)): foreach($order_mess as $k=>$vo): ?><tr role="row" style="text-align: center;">
                                            ...
                                            <td>
                                              ...
                                              <td  style="width: 140px;">
                                                  <a href="<?php echo U('Admin/Order/added_services_edit',array('id'=>$vo['id']));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="处理订单"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
