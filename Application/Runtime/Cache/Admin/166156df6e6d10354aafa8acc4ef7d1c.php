                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered table-striped" >
                                    ...
                                    <tr>
                                        <td>单位名称:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($info["company_name"]); ?>" name="company_name" class="form-control" style="width:250px;"/>
                                        </td>
                                        <td>单位负责人:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($info["linkman"]); ?>" name="linkman" id="linkman"  class="form-control" style="width:250px;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>负责人联系电话:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($info["company_mobile"]); ?>" name="company_mobile" class="form-control" style="width:250px;"/>
                                        </td>
                                        <td>座机号:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($info["tel"]); ?>" name="tel" id="tel"  class="form-control" style="width:250px;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>下单账号:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline">
                                                <input type="radio" name="ways" value="1" <?php if($info["ways"] == 1): ?>checked="checked"<?php endif; ?>>挂靠
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio"  name="ways"  value="2" <?php if($info["ways"] == 2): ?>checked="checked"<?php endif; ?>>代理
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
...
<script>
    ...
    function send_mess(id){
        ...
        var url = "/index.php?m=Admin&c=Order&a=ajax_send_mess&table_name=sb_company_order&mobile="+mobile+'&content='+content+"&id="+id;
        $.ajax({
            url:url,
            type:'get',
            dataType:'json',
