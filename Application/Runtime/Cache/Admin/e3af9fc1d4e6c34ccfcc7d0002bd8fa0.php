                ...
                <nav class="navbar navbar-default">
                    <div class="collapse navbar-collapse">
                        <div class="navbar-form row">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo U('Manage/area_new_add');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>新增地区</a>
                            </div>
                        </div>
                    </div>
                </nav>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($area_list)): $k = 0; $__LIST__ = $area_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo U('Admin/Manage/area_add',array('id'=>$list['id']));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
