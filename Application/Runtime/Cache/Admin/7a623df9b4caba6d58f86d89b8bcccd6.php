                                ...
                                <table id="list-table" class="table table-bordered table-striped dataTable">
                                    ...
                                    <?php if(is_array($order_mess)): foreach($order_mess as $k=>$vo): ?><tr role="row" style="text-align: center;">
                                            ...
                                            <td  style="width: 200px;">
                                                  ...
                                                  <a href="<?php echo U('Admin/Order/company_order',array('id'=>$vo['id']));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="处理订单"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
