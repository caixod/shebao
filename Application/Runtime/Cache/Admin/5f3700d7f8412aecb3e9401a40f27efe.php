                            ...
                            <div class="collapse navbar-collapse">
                                <form class="navbar-form form-inline" action="" method="get" onsubmit="return check_form();">
                                    ...
                                    <div class="form-group pull-right">
                                        <div class="col-md-2">
                                            <a href="<?php echo U('Manage/add_sms_send');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>发送短信</a>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="col-sm-12">
                                <table id="list-table" class="table table-bordered table-striped dataTable">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr role="row" style="text-align: center;">
                                        ...
                                        <tr id="tr<?php echo ($vo["id"]); ?>" style="display: none;"><td colspan="4"><?php echo ($vo["content"]); ?></td></tr><?php endforeach; endif; ?>
                                    </tbody>
                                    <tfoot>
