                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered table-striped" >
                                    ...
                                    <tr>
                                        <td>转出地:</td>
                                        <td>
                                            <?php echo ($info["op_name"]); ?>—<?php echo ($info["oc_name"]); ?>
                                        </td>
                                        <td>转入地:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>办理要求:</td>
                                        <td colspan="3">
                                            <textarea name="mark" cols="100" rows="3"><?php echo ($info["mark"]); ?></textarea>
                                        </td>
                                    ...
                                    <!--<tr>-->
                                        <!--<td style="text-align: center;">发送缴费通知短信:</td>-->
                                        <!--<td colspan="3">-->
                                            <!--<div class="row">-->
                                                <!--<div class="col-lg-6">-->
...
<script>
    ...
    function send_mess(id){
        ...
        var url = "/index.php?m=Admin&c=Order&a=ajax_send_mess&table_name=gjj_zhuanyi&mobile="+mobile+'&content='+content+"&id="+id;
        $.ajax({
            url:url,
            type:'get',
            dataType:'json',
