...
class UpgradeLogic extends RelationModel
{
    ...
    function  __construct() {
        ...
        $this->service_url = "http://service.shop.yiqidongfang.com/index.php?m=Home&c=Index&a=checkVersion";
   }       
   /**
    * 检查是否有更新包
    * @return type 提示语
    */
    ...
    public  function UpgradeLog($to_key_num){
        ...
        $vaules = array(                
         ...
         $url = "http://service.shop.yiqidongfang.com/index.php?m=Home&c=Index&a=upgradeLog&".http_build_query($vaules);
