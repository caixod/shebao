...
//               dump($_POST);die;
               $this->success("操作成功",U("Home/Order/friend_info"));
           }else{
//               dump(222);die;
               $this->error("错误,请重试",U("Home/Order/friend_info"));
           }
    ...
    public function added_service(){
        ...
        if(IS_POST){
            if($model->create()){
                ...
                $ret= $model->add();
                if($ret){
                    $this->success("提交成功,我们工作人员将会和您联系");
                }else{
                    $this->error("出错啦……");
                }
            }else{
...
//                       dump( $model->image);
                ...
                $this->success("操作成功",U("Home/Order/company_staff"));
            }else{
                $this->error("错误,请重试",U("Home/Order/company_staff"));
            }
