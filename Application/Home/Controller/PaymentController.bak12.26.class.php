...
class PaymentController extends BaseController {
     ...
     * 析构流函数
     *
     * order_id   table_name   pay_radio
     *
     */
    public function  __construct() {   
        parent::__construct();                                                  
        // tpshop 订单支付提交
        $pay_radio = $_REQUEST['pay_radio'];//$pay_radio=pay_code="weixin"
    ...
    // 服务器点对点 // http://www.shop.yiqidongfang.com/index.php/Home/Payment/notifyUrl
    public function notifyUrl(){            
        $this->payment->response();            
        exit();
    }

    // 页面跳转 // http://www.shop.yiqidongfang.com/index.php/Home/Payment/returnUrl
