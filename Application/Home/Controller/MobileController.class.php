                ...
                if($coupon){
                    ...
                    $id=D("order_info")->getLastInsID();
                     ...
                     if($r){
                         ...
                         header("location:".U('MobileDopay/createDLBPay'));//去支付
                     }else{
                         $this->error("错误……");die;
                     }
                }else{
...
//    }
    ...
    public function index(){
        ...
        header("location:".U('Home/Mobile/shebao_dj'));
    }
...
//            $service_name sure_order_info
            header("location:".U('Mobile/sure_order_info',array('service_name'=>"社保补缴")));
        exit;
        }
...
//            die;
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"个人社保代缴")));//订单确认页面
...
//            dump($_POST);die;
            ...
            $actual_info= D("users")->where(['user_id'=>$user_id])->find();
                ...
                if($id){
                    ...
                    header("location:".U('Mobile/sure_order_info',array('service_name'=>"社保转移")));//订单确认页面
...
//            dump($_POST);die;
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"公积金转移")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//            dump($_POST);die;
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"住房公积金提取")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//            $tq_type=I('post.tq_type');
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"医疗手工帐报销")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//            $tq_type=I('post.tq_type');
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"生育待遇申领")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//            $tq_type=I('post.tq_type');
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"异地就医备案")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
    ...
    public function sb_editinfo(){
        ...
        if(IS_POST){
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"社保信息修改")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//            dump($_POST);die;
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"个人所得税申报")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//            dump($_POST);die;
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"退休养老办理")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
    ...
    public function school_info(){
        ...
        if(IS_POST){
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"孩子上学材料")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//            dump($_POST);die;
            ...
            if($id){
                ...
                header("location:".U('Mobile/sure_order_info',array('service_name'=>"天津人才引进")));//订单确认页面
//                    header("location:".U('Dopay/createDLBPay'));
            }else{
                $this->error('订单提交失败,请重新提交');
            }
...
//       dump($area_list);
    ...
    public function logout(){
        ...
        session_unset();
        session_destroy();
        $this->success("退出成功",U('Home/Mobile/login'));
            ...
            if($r){
                ...
                if($res){
                    ...
                    session('user_type',$r['user_type']);
                        ...
                        $this->success('密码找回成功',U('Home/Mobile/shebao_dj'));
...
//        dump($data);
        ...
        if($data){
            ...
            $this->success('登录成功',U('Home/Mobile/shebao_dj'));
...
//            dump($_POST);die;
            ...
            if(!$r){
                ...
                if($res){
                    ...
                    $this->success('注册成功',U('Home/Checklogin/shebao_dj'));
...
//            die;
            ...
            header("location:".U('Mobile/sure_order_info',array('service_name'=>"企业社保办理")));//订单确认页面
//            header("location:".U('Dopay/createDLBPay'));
//                  header("Location:".U('Home/Checklogin/sb_daijiao_to_order')."");
        ...
        $friend=D('users')
            ->where("(parent_id={$_SESSION['user_id']} or user_id={$_SESSION['user_id']}) and is_lock=0 and is_staff=1 ")
            ->order('parent_id ASC')->select();//用户的朋友信息
