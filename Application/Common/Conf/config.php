...
//    'ERROR_PAGE'=>'/Index/Index/error_page.html',
    ...
    // 'site_url'=>'http://www.shop.yiqidongfang.com', // tpshop 网站域名 已经改写入数据库
    'DEFAULT_MODULE'        =>  'Home',  // 默认模块
    //'DEFAULT_MODULE'        =>  'Index',  // 默认模块
    'DEFAULT_CONTROLLER'    =>  'Checklogin', // 默认控制器名称
    'DEFAULT_ACTION'        =>  'login', // 默认操作名称
    
    'APP_SUB_DOMAIN_DEPLOY'   =>    0, // 开启子域名或者IP配置
//    'APP_SUB_DOMAIN_RULES'    =>    array(
//         'm.ss.com'   => 'Mobile/',  // 手机访问网站
//    ),
    ...
    'AMAP_KEY' => 'b6c2c19cf45cd3d2b82541bc857eed7c', //密钥key
        //地理编码API服务地址
    'AMAP_RESTAPI_URL' => 'http://restapi.amap.com/v3/geocode/regeo?output=JSON&radius=1000&extensions=all&',
        /*坐标转换地址*/
    'AMAP_SWITCH_LNG_LAT_URL' => 'http://restapi.amap.com/v3/assistant/coordinate/convert?',
    /*高德地图配置*/
);