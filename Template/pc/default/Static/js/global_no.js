...
/**
 * 获取城市
 * //1为添加过的flag==1 2为未添加过 的flag==0   0为两者不考虑的。
 * @param t  省份select对象
 */
function get_city(t){
    ...
    var url = '/index.php?m=Home&c=Api&a=getHasRegion&level=2&flag=1&parent_id='+ parent_id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
...
function get_city_t(t){
    ...
    //var url = '/index.php?m=Home&c=Api&a=getRegion&level=2&parent_id='+ parent_id;
    var url = '/index.php?m=Home&c=Api&a=getHasRegion&flag=1&level=2&parent_id='+ parent_id;
...
* ajax_getBase
* **/
function get_base(obj){
    var city=$(obj).val();
    var url = '/index.php?m=Home&c=Checklogin&a=ajax_getBase&id='+city;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
